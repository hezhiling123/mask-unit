...
public class WrapperResponse<T> implements Serializable {
    ...
    public static <T> WrapperResponse<T> success(T data) {
        return new WrapperResponse<T>(SUCCESS, WrapperResponse.ResponseType.TYPE_SUCCESS.getType(), MSG_SUCCESS, data);
    }

    public static <T> WrapperResponse<T> success(String message, T data) {
        message = message != null && message.length() > 0 ? message : MSG_SUCCESS;
        return new WrapperResponse<T>(SUCCESS, WrapperResponse.ResponseType.TYPE_SUCCESS.getType(), message, data);
    }

    public static <T> WrapperResponse<T> info(int code, String message, T data) {
        message = message != null && message.length() > 0 ? message : MSG_SUCCESS;
        return new WrapperResponse<T>(code, WrapperResponse.ResponseType.TYPE_INFO.getType(), message, data);
    }
    ...
    public static <T> WrapperResponse<T> warning(int code, String message, T data) {
        ...
        return new WrapperResponse<T>(code, WrapperResponse.ResponseType.TYPE_WARNING.getType(), message, data);
    }
    ...
    public static <T> WrapperResponse<T> fail(T data) {
        return new WrapperResponse<T>(FAIL, WrapperResponse.ResponseType.TYPE_ERROR.getType(), MSG_FAIL, data);
    }

    public static <T> WrapperResponse<T> fail(String message, T data) {
        message = message != null && message.length() > 0 ? message : MSG_FAIL;
        return new WrapperResponse<T>(FAIL, WrapperResponse.ResponseType.TYPE_ERROR.getType(), message, data);
    }
